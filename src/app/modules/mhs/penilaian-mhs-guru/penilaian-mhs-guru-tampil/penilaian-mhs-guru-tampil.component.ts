...
@Component({
  selector: 'app-penilaian-mhs-guru-tampil',
  templateUrl: './penilaian-mhs-guru-tampil.component.html',
  styleUrls: ['./penilaian-mhs-guru-tampil.component.css']
})
export class PenilaianMhsGuruTampilComponent implements OnInit {
